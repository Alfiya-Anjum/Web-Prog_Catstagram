...
from .models import Post  # Add this import statement
...
def search(request):
    ...
    if request.method == 'POST':
        ...
        if username:
            ...
            # Handle case where no username is provided in the form
            # You can add a message or perform some other action here
            pass
    else:
        # Handle other HTTP request methods (GET, etc.) if needed
        pass
    
    print("Username Profile List:", username_profile_list)  # Debugging statement
